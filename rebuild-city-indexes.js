...
const CITIES = {
  ...
  moscow:      { nom: 'Москва',              prep: 'в Москве',                gen: 'Москвы',                shortNom: 'Москве',             address: '101000, г. Москва, ул. Мясницкая, д. 24, офис 102',          region: 'Москвы' },
  spb:         { nom: 'Санкт-Петербург',     prep: 'в Санкт-Петербурге',      gen: 'Санкт-Петербурга',      shortNom: 'Санкт-Петербурге',   address: '191025, г. Санкт-Петербург, Невский проспект, д. 42, офис 15', region: 'Санкт-Петербурга' },
  novosibirsk: { nom: 'Новосибирск',         prep: 'в Новосибирске',          gen: 'Новосибирска',          shortNom: 'Новосибирске',       address: '630099, г. Новосибирск, Красный проспект, д. 28, офис 412',  region: 'Новосибирской области' },
  ekaterinburg:{ nom: 'Екатеринбург',        prep: 'в Екатеринбурге',         gen: 'Екатеринбурга',         shortNom: 'Екатеринбурге',      address: '620014, г. Екатеринбург, ул. Малышева, д. 51, офис 805',     region: 'Свердловской области' },
  kazan:       { nom: 'Казань',              prep: 'в Казани',                gen: 'Казани',                shortNom: 'Казани',             address: '420111, г. Казань, ул. Баумана, д. 12, офис 301',            region: 'Республики Татарстан' },
  nn:          { nom: 'Нижний Новгород',     prep: 'в Нижнем Новгороде',      gen: 'Нижнего Новгорода',     shortNom: 'Нижнем Новгороде',   address: '603005, г. Нижний Новгород, ул. Большая Покровская, д. 15, офис 204', region: 'Нижегородской области' },
  chelyabinsk: { nom: 'Челябинск',           prep: 'в Челябинске',            gen: 'Челябинска',            shortNom: 'Челябинске',         address: '454091, г. Челябинск, проспект Ленина, д. 64, офис 512',     region: 'Челябинской области' },
  samara:      { nom: 'Самара',              prep: 'в Самаре',                gen: 'Самары',                shortNom: 'Самаре',             address: '443099, г. Самара, ул. Ленинградская, д. 45, офис 311',      region: 'Самарской области' },
  rostov:      { nom: 'Ростов-на-Дону',      prep: 'в Ростове-на-Дону',       gen: 'Ростова-на-Дону',       shortNom: 'Ростове-на-Дону',    address: '344002, г. Ростов-на-Дону, ул. Большая Садовая, д. 82, офис 219', region: 'Ростовской области' },
  ufa:         { nom: 'Уфа',                 prep: 'в Уфе',                   gen: 'Уфы',                   shortNom: 'Уфе',                address: '450077, г. Уфа, ул. Ленина, д. 32, офис 104',                region: 'Республики Башкортостан' },
  voronezh:    { nom: 'Воронеж',             prep: 'в Воронеже',              gen: 'Воронежа',              shortNom: 'Воронеже',           address: '394036, г. Воронеж, проспект Революции, д. 18, офис 302',    region: 'Воронежской области' },
  volgograd:   { nom: 'Волгоград',           prep: 'в Волгограде',            gen: 'Волгограда',            shortNom: 'Волгограде',         address: '400066, г. Волгоград, проспект Ленина, д. 12, офис 410',     region: 'Волгоградской области' },
};
