...
const moveTypes: Array<{ id: MoveType; label: string; icon: string; description: string }> = [
  { id: 'apartment', label: 'Квартирный', icon: '🏠', description: 'мебель и личные вещи' },
  { id: 'office', label: 'Офисный', icon: '🏢', description: 'рабочие места и IT' },
  { id: 'commercial', label: 'Коммерческий', icon: '📦', description: 'товар, склад, паллеты' }
];
